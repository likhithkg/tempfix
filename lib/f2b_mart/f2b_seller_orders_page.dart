...
class F2BSellerOrdersPage extends StatefulWidget {
  const F2BSellerOrdersPage({super.key});
  @override
  State<F2BSellerOrdersPage> createState() => _F2BSellerOrdersPageState();
}

class _F2BSellerOrdersPageState extends State<F2BSellerOrdersPage>
  ...
  List<F2BOrder> _forStatus(List<F2BOrder> all, String status) =>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<List<F2BOrder>>(
...
class _OrderList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (orders.isEmpty) {
      return Center(
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Text(_emptyEmoji(status), style: const TextStyle(fontSize: 56)),
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) => _OrderCard(order: orders[i], svc: svc),
    );
  }
...
class _OrderCardState extends State<_OrderCard> {
        ...
        Container(
          ...
          child: Row(children: [
            ...
            Container(
              ...
              child: Text(
                F2BOrder.statusLabel(order.status),
                style: TextStyle(
                    fontSize: 10,
  ...
  Color _statusColor(String status) {
    switch (status) {
      ...
      case 'collected': return const Color(0xFF1B5E20);
